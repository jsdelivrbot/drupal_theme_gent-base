...
(function ($, window, document, undefined) {
  ...
  var rcrumbs = 'rcrumbs',
    defaults = {
      ...
      windowReady: true, // To activate/deactivate the resizing of the crumbs on window ready event
  ...
  Plugin.prototype = {
    ...
    _init: function () {
      ...
      if (this.options.windowReady) {
        this._showOrHideCrumbsListOnWindowReady();
      }
    ...
    _getHiddenElWidth: function (element) {
      ...
      elementClone.appendTo(this.$crumbsList);
       resultWithoutMargin = elementClone.width();
       result =  resultWithoutMargin + 20;
      elementClone.remove();
      return result;
    },
    ...
    _showOrHideCrumbsList: function (disableAnimation) {
      var that = this;
      this.remainingSpaceToDisplayCrumbs = this.$element.outerWidth(true);
      this.nbCrumbDisplayed = 0;
      this.totalCrumbsWidth = 0;
    ...
    _showOrHideCrumbsListOnWindowReady: function () {
      var that = this;
      $(document).ready(function () {
        var rcrumbWidth = that.$element.outerWidth(true);
